# Common settings for all deploys
# SETTINGS ARE OVERRIDDEN BY SPECIFIC DEPOLYMENTS

import sys
from path import path

#Django and associated things go in project
PROJECT_ROOT = path(__file__).abspath().dirname().dirname()
#Wider site stuff and the virtualenv in the parent
SITE_ROOT = PROJECT_ROOT.dirname()

#Add that to the python path
