DROP VIEW IF EXISTS sample_context;
...
CREATE TABLE sample_contexts AS SELECT sample_context_id as sample_context, title, description, study_id, location_id FROM sample_context;
